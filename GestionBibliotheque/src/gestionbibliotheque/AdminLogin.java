...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Espace d'administration");
    ...
    private void ConnexionBtnActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {                                             
    	if(PasswordLogin.getText().isEmpty()){
            JOptionPane.showMessageDialog(this,"Entrez le mot de passe administrateur !!! ");
        }
